...
define_ships = ->
  ...
  model = [ [0,15,10],    [80,5,-45],    [25,-5,45],
          [-25,-5,45],  [-80,5,-45],   [0,15,-45],
          [95,-5,-25],  [-95,-5,-25],  [95,-5,-45],
          [-95,-5,-45], [-25,-15,-45], [25,-15,-45],
          [-60,-5,-45], [-60,5,-45],   [-75,0,-45],
          [60,5,-45],   [75,0,-45],    [60,-5,-45],
          [-5,5,-45],   [-5,-10,-45],  [-30,0,-45],
          [-30,-5,-45], [5,5,-45],     [5,-10,-45],
          [30,0,-45],   [30,-5,-45],   [0,15,10] ]

  facets = [ [0,1,2,142,0], [0,3,4,142,0], [0,5,1,194,0], [0,4,5,194,0],
  ...
  cobra.vertices.push(new THREE.Vertex(new THREE.Vector3(v[0],v[1],v[2]))) for v in model
  cobra.faces.push(new THREE.Face3(f[0], f[1], f[2])) for f in facets
